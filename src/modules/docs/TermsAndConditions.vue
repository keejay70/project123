        ...
        <div class="modal-body">
          <div class="guide-holder">
            <ul class="first-ul">
              ...
              <li><strong>LINKS TO THIRD PARTIES & NO ENDORSEMENT</strong></li>
              <li>
